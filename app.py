...
connection_string = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:mera-sql-server.database.windows.net,1433;Database=mera-database;Uid=amit;Pwd=Harekrishna@123;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
